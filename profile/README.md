...
- [GitHub Project: declarative-migrations-project](https://github.com/orgs/declarative-migrations/projects/1)
- [Linear planning project](https://linear.app/denman/project/githubcomdeclarative-migrations-ffa3841a100d)
...
- Canonical Linear project: https://linear.app/denman/project/githubcomdeclarative-migrations-ffa3841a100d
- Organization defaults: https://github.com/declarative-migrations/.github
- Canonical agent policy: https://github.com/declarative-migrations/.github/blob/main/agents.md
- Security policy: https://github.com/declarative-migrations/.github/security/policy
...
`declarative-migrations` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
