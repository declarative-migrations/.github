...
3. Review linked pull requests, issues, Linear work, related repositories in `declarative-migrations`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
