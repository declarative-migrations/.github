# declarative-migrations organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`declarative-migrations`](https://github.com/declarative-migrations).

## Canonical organization links

- GitHub organization: https://github.com/declarative-migrations
- Public organization defaults: https://github.com/declarative-migrations/.github
